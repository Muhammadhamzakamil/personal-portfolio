      ...
      <div className="p-4 w-[100%] md:w-1/3">
        <div className="flex rounded-lg h-full  p-8 flex-col">
          ...
          <div className='relative h-1 w-full bg-gray-300 rounded-xl '>
            <div className='absolute bg-orange-500 h-1 rounded-lg w-[100%]'></div>
          </div>
        ...
        <div className="flex rounded-lg h-full  p-8 flex-col">
          ...
          <div className="flex-grow">
          <div className='relative h-1 w-full bg-gray-300 rounded-xl '>
            <div className='absolute bg-orange-500 h-1 rounded-lg w-[95%]'></div>
          </div>
        ...
        <div className="flex rounded-lg h-full  p-8 flex-col">
          ...
          <div className="flex-grow">
          <div className='relative h-1 w-full bg-gray-300 rounded-xl '>
            <div className='absolute bg-orange-500 h-1 rounded-lg w-[90%]'></div>
          </div>
        ...
        <div className="flex rounded-lg h-full  p-8 flex-col">
          ...
          <div className="flex-grow">
          <div className='relative h-1 w-full bg-gray-300 rounded-xl '>
            <div className='absolute bg-orange-500 h-1 rounded-lg w-[70%]'></div>
          </div>
        ...
        <div className="flex rounded-lg h-full  p-8 flex-col">
          ...
          <div className="flex-grow">
          <div className='relative h-1 w-full bg-gray-300 rounded-xl '>
            <div className='absolute bg-orange-500 h-1 rounded-lg w-[80%]'></div>
          </div>
        ...
        <div className="flex rounded-lg h-full  p-8 flex-col">
          ...
          <div className="flex-grow">
          <div className='relative h-1 w-full bg-gray-300 rounded-xl '>
            <div className='absolute bg-orange-500 h-1 rounded-lg w-[40%]'></div>
          </div>
          <p className='font-bold text-orange-500 text-right '>40%</p>
          </div>
        </div>
      </div>
